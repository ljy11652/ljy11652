...
# 输入文件中的名义p值和校正p值绘制热图
tmp <- matrix(c(0.04695305,0.1318681,0.1998002,0.6123876,0.93806194,0.6363636,0.8211788,0.3866134, 
                0.3756244,1,1,1,1,1,1,1), # Bonferroni校正p值
              nrow = 4,byrow = T,dimnames = list(c("TGF-beta-A_p","TGF-beta-I_p","TGF-beta-A_b","TGF-beta-I_b"),c("CTAL4-noR","CTLA4-R","PD1-noR","PD1-R")))
